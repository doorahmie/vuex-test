    ...
    <v-app id="inspire">
        ...
        <v-app-bar class="px-3" color="grey-lighten-4" height="72" flat>
            ...
            <v-responsive max-width="156">
                <v-text-field bg-color="grey-lighten-1" density="compact" rounded="pill" variant="solo-filled" flat
        ...
        <v-footer height="72" app>
            <v-text-field bg-color="grey-lighten-1" class="overflow-hidden" density="compact" rounded="pill"
                variant="solo-filled" flat hide-details></v-text-field>
        </v-footer>
    </v-app>
</template>